...
<html>
    ...
    <body>
        ...
        <a href="panelprincipal_es.php?language=1&nombre=<?php echo $nombre ?>&chk=<?php echo $chk ?>" >ES (Español) </a> <?php echo"|"; ?> <a href="panelprincipal_en.php?language=2&nombre=<?php echo $nombre ?>&chk=<?php echo $chk ?>">EN (English)</a><br/>
